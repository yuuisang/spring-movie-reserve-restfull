...
public class MovieAdminController {
	...
	public void managementMovie(Model model, int page) {
...
//		String resourcePath = request.getSession().getServletContext().getRealPath("upload");
		...
		MultipartRequest multi = null; // com.oreilly.servlet.MultipartRequest 임포트
			...
			String mov_title = multi.getParameter("mov_title");
			String mov_director = multi.getParameter("mov_director");
			String mov_actors = multi.getParameter("mov_actors");
			String mov_genre = multi.getParameter("mov_genre");
			int mov_runtime = Integer.parseInt(multi.getParameter("mov_runtime"));
			String mov_openDate = multi.getParameter("mov_openDate");
			String mov_grade = multi.getParameter("mov_grade");
			String mov_intro = multi.getParameter("mov_intro");
//			String mov_poster = multi.getParameter("mov_poster");
			String mov_poster = multi.getFilesystemName("mov_poster");
			String mov_still1 = multi.getFilesystemName("mov_still1");
			String mov_still2 = multi.getFilesystemName("mov_still2");
			String mov_still3 = multi.getFilesystemName("mov_still3");
