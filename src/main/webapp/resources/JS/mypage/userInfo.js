...
function makeInfoDiv(){
	...
	result += "<div class='memInfo' id='mem_id'>아이디 : " + dataSave.data[0].mem_id + "</div>"
			...
			+ "<div class='memInfo' id='mem_pw'>비밀번호 : <input type='password' id='inputPw' value='" + dataSave.data[0].mem_pw + "'></div>"
			+ "<div class='memInfo' id='mem_pwChk'>비밀번호 확인 : <input type='password' id='inputPwChk' value='" + dataSave.data[0].mem_pw + "'></div>"
			+ "<div class='memInfo' id='mem_phone'>핸드폰 번호 : " 
				+ "<input type='text' id='inputPhone1' value='" + arr[0] + "'>" 
				+ "<input type='text' id='inputPhone2' value='" + arr[1] + "'>" 
				+ "<input type='text' id='inputPhone3' value='" + arr[2] + "'>" 				
			+ "</div>"
	...
	resultDelete += "<div class='memDelete'>비밀번호 인증 성공시 모든 회원정보와 예매한 영화는 <br>환불이 불가하오니 확인 부탁드립니다.</div>"
				+ "<div class='memDelete'>"
					+ "비밀번호 : <input type='password' id='deleteChk'>"
				+ "</div>"
